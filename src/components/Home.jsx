...
export const Home = () => {
    return (
        <div className='relative isolate overflow-hidden h-dvh bg-[#DFE3F0] select-none'>
            ...
            <main className='flex flex-col px-10 mt-4 mx-auto sm:max-w-[75%] xl:max-w-6xl'>
                ...
                <div className="text-center lg:flex-auto lg:py-16 lg:text-left mb-5">
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        <Link
                            className="cursor-pointer drop-shadow-md rounded-full hover:bg-pink px-6 py-2.5 text-sm font-semibold hover:text-white border-2 border-pink text-pink shadow-sm bg-trans transition hover:duration-500 ease-in-out"
                            to="/"
                        >
                            Go home
                        </Link>
